...
console.log("this is the pathname", pathname)
  ...
  const handlePathChange = () => {
    ...
    const formsWithAllConditions = filteredForms.filter((form) => {
      const { urlEnabled, dateEnabled, timeEnabled, url, date, time } = form || {};
  console.log("this is pathname", pathname, url)
    console.log(form)
      const isUrlMatch = !urlEnabled || (url && pathname.includes(url));
  console.log("isUrlMatch",isUrlMatch, urlEnabled)
  console.log("Current Date:", currentDate);
  console.log("Form Date:", form.date);
  console.log("Current Time:", currentTime);
  console.log("Form Time:", form.time);
  
  const isDateMatch = dateEnabled ? date === currentDate : true;
  const isTimeMatch = timeEnabled ? time === currentTime : true;
  
  console.log("Is Date Match:", isDateMatch);
  console.log("Is Time Match:", isTimeMatch);

      console.log("all and",isUrlMatch && isDateMatch && isTimeMatch)
    ...
    const formsWithoutConditions = filteredForms.filter(
      (form) => !(form?.urlEnabled || form?.dateEnabled || form?.timeEnabled),
    );
